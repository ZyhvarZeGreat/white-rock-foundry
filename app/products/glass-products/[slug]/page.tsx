...
type GlassType = 'tempered' | 'laminated' | 'tinted' | 'frosted' | 'mirrored' | 'smart';
...
export default async function GlassTypePage({ params }: PageProps) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{glassType.title}</h1>
          <p className="text-xl text-gray-600 max-w-3xl">{glassType.description}</p>
        </div>
      </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {glassType.features.map((feature, index) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {Object.entries(glassType.specifications).map(([key, value]) => (
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {glassType.applications.map((application, index) => (
