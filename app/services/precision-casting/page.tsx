          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mb-4 text-gray-700">
                Verdant lam specializes in advanced precision casting techniques that deliver complex metal
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="mb-4 text-gray-700">
                At Verdant lam, quality is built into every step of our casting process. Our comprehensive
