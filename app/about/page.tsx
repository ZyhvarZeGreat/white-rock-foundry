            ...
            <ScrollAnimation className="mx-auto" type="fade-up">
              <div className="group">
                <div className="relative overflow-hidden rounded-lg">
                  <Image
                    src="https://images.pexels.com/photos/1181391/pexels-photo-1181391.jpeg?auto=compress&cs=tinysrgb&w=1260&h=450&dpr=1"
                    alt="CEO"
                    width={300}
                    height={400}
                ...
                <div className="mt-4 text-center">
                  <h3 className="font-bold text-lg">Martin Abbah Okute</h3>
