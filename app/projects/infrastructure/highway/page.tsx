          ...
          <div className="container mx-auto relative z-10 py-24 md:py-36 px-4">
            <ScrollAnimation type="fade-up">
              ...
              <p className="text-white text-lg mb-8 max-w-2xl">
                A state-of-the-art highway showcasing the strength and durability of GLB materials in transportation infrastructure.
              </p>
            </ScrollAnimation>
          </div>
        </section>
              ...
              <ScrollAnimation type="fade-right">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    This modern highway demonstrates the exceptional capabilities of GLB materials in transportation infrastructure. 
                    The project combines innovative engineering with sustainable design principles.
                  </p>
                  <p className="text-gray-600 mb-4">
                    GLB materials were selected for their superior performance in demanding traffic conditions, 
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    <div>
                      ...
                      <p className="text-gray-600">Urban Corridor</p>
                    </div>
                    <div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <ScrollAnimation type="fade-up">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    High-performance GLB structural elements designed for transportation infrastructure.
                  </p>
                </div>
              </ScrollAnimation>
              ...
              <ScrollAnimation type="fade-up" delay={400}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold mb-4">Drainage Design</h3>
                  <p className="text-gray-600">
                    Efficient drainage systems with GLB-integrated components.
                  </p>
                </div>
              </ScrollAnimation>
            </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mb-8 text-[#0a3b25]">
                Contact us today to discuss how our GLB solutions can enhance your transportation infrastructure.
              </p>
              <Link href="/quote">
