          ...
          <div className="container mx-auto relative z-10 py-24 md:py-36 px-4">
            <ScrollAnimation type="fade-up">
              ...
              <p className="text-white text-lg mb-8 max-w-2xl">
                A landmark bridge showcasing the strength and durability of GLB materials in civil infrastructure.
              </p>
            </ScrollAnimation>
          </div>
        </section>
              ...
              <ScrollAnimation type="fade-right">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    This modern bridge demonstrates the exceptional capabilities of GLB materials in civil infrastructure. 
                    The structure combines innovative engineering with sustainable design principles.
                  </p>
                  <p className="text-gray-600 mb-4">
                    GLB materials were selected for their superior performance in demanding environmental conditions, 
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    <div>
                      ...
                      <p className="text-gray-600">River Crossing</p>
                    </div>
                    <div>
                      <h3 className="font-bold text-[#0a3b25]">Length</h3>
                      <p className="text-gray-600">500 meters</p>
                    </div>
                    <div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <ScrollAnimation type="fade-up">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    High-performance GLB structural elements designed for civil infrastructure.
                  </p>
                </div>
              </ScrollAnimation>
              ...
              <ScrollAnimation type="fade-up" delay={400}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold mb-4">Environmental Design</h3>
                  <p className="text-gray-600">
                    Sustainable design elements with minimal environmental impact.
                  </p>
                </div>
              </ScrollAnimation>
            </div>
