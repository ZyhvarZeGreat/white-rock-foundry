            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <ScrollAnimation type="fade-right">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    This distribution center demonstrates the capabilities of GLB materials in large-scale industrial 
                    construction. The facility features innovative structural solutions that combine functionality with 
                    operational efficiency.
                  </p>
                  <p className="text-gray-600 mb-4">
                    The use of GLB materials throughout the center provides superior strength and durability while 
                    maintaining a clean, professional environment for distribution operations.
                  </p>
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    <div>
                      <h3 className="font-bold text-[#0a3b25]">Location</h3>
                      <p className="text-gray-600">Logistics Park</p>
                    </div>
                    <div>
                      <h3 className="font-bold text-[#0a3b25]">Size</h3>
                      <p className="text-gray-600">300,000 sq ft</p>
                    </div>
                    <div>
              ...
              <ScrollAnimation type="fade-left">
                <div className="relative h-[500px] rounded-lg overflow-hidden">
                  <Image
                    src="https://images.pexels.com/photos/3862130/pexels-photo-3862130.jpeg"
                    alt="Distribution Center Overview"
                    fill
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <ScrollAnimation type="fade-up" delay={200}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold mb-4">Storage Areas</h3>
                  <p className="text-gray-600">
                    Efficient storage spaces with GLB accents and custom fixtures.
                  </p>
                </div>
              </ScrollAnimation>
              ...
              <ScrollAnimation type="fade-up" delay={400}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold mb-4">Loading Docks</h3>
                  <p className="text-gray-600">
                    Well-designed loading docks with GLB architectural features.
                  </p>
                </div>
              </ScrollAnimation>
            </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 font-heading">
                Ready to Enhance Your Distribution Facility?
              </h2>
