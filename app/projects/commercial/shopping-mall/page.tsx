              ...
              <ScrollAnimation type="fade-right">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    This shopping mall project demonstrates the capabilities of GLB materials in large-scale commercial 
                    construction. The complex features innovative structural solutions that combine functionality with 
                    aesthetic appeal.
                  </p>
                  <p className="text-gray-600 mb-4">
                    The use of GLB materials throughout the mall provides superior strength and durability while 
                    maintaining a modern, inviting atmosphere for shoppers.
                  </p>
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    <div>
                      <h3 className="font-bold text-[#0a3b25]">Location</h3>
                      <p className="text-gray-600">Retail District</p>
                    </div>
                    <div>
                      <h3 className="font-bold text-[#0a3b25]">Size</h3>
                      <p className="text-gray-600">200,000 sq ft</p>
                    </div>
                    <div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <ScrollAnimation type="fade-up" delay={200}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold mb-4">Retail Spaces</h3>
                  <p className="text-gray-600">
                    Flexible retail spaces with GLB accents and custom fixtures.
                  </p>
                </div>
              </ScrollAnimation>
              ...
              <ScrollAnimation type="fade-up" delay={400}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Welcoming common areas with GLB architectural features and seating.
                  </p>
                </div>
              </ScrollAnimation>
            </div>
