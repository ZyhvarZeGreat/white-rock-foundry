              ...
              <ScrollAnimation type="fade-right">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    This luxury hotel project showcases the elegance and versatility of GLB materials in high-end 
                    commercial construction. The project features custom-designed structural solutions that combine 
                    functionality with sophisticated aesthetics.
                  </p>
                  <p className="text-gray-600 mb-4">
                    The use of GLB materials throughout the hotel provides superior strength and durability while 
                    maintaining a luxurious, welcoming atmosphere for guests.
                  </p>
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    <div>
                      <h3 className="font-bold text-[#0a3b25]">Location</h3>
                      <p className="text-gray-600">Prime Area</p>
                    </div>
                    <div>
                      <h3 className="font-bold text-[#0a3b25]">Size</h3>
                      <p className="text-gray-600">100,000 sq ft</p>
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <ScrollAnimation type="fade-up" delay={200}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Sophisticated interior design with GLB accents and custom fixtures.
                  </p>
                </div>
              </ScrollAnimation>
              ...
              <ScrollAnimation type="fade-up" delay={400}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold mb-4">Guest Amenities</h3>
                  <p className="text-gray-600">
                    Premium guest amenities with GLB architectural features and furniture.
                  </p>
                </div>
              </ScrollAnimation>
            </div>
